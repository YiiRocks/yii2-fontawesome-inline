...
class IconComponentTest extends tests {
	...
	public function testFixedWidth() {
		$this->assertNotContains('svg-inline--fa-fw', Yii::$app->fontawesome->name('cookie')->show());
		$this->assertContains('svg-inline--fa-fw', Yii::$app->fontawesome->name('cookie')->fixedWidth(true)->show());
	}
