...
html;
        ...
        $this->assertEquals($expected1, (string) Yii::$app->fontawesome->name('@vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/icons/file-code.svg'));
        $this->assertEquals($expected2, (string) Yii::$app->fontawesome->name('@vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/icons/file-code.svg')->addClass(true));
    }

    public function testFill(): void
    {
        $this->assertStringContainsString('fill="currentColor"', (string) Yii::$app->fontawesome->name('cookie'));
        $this->assertStringNotContainsString('fill', (string) Yii::$app->fontawesome->name('cookie')->fill(''));
        $this->assertStringContainsString('fill="#003865"', (string) Yii::$app->fontawesome->name('cookie')->fill('#003865'));
    }
