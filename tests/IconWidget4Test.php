...
class IconWidget4Test extends tests
{
    public function testBasic(): void
    {
        ...
        $this->assertStringContainsString('viewBox="0 0 512 512" aria-hidden="true" role="img" class="svg-inline--fa svg-inline--fa-w-16" id="w0"', IconWidget::widget(['name' => 'cookie']));
        $this->assertStringContainsString('viewBox="0 0 192 512" aria-hidden="true" role="img" class="svg-inline--fa svg-inline--fa-w-6" id="w1"', IconWidget::widget(['name' => 'ellipsis-v']));
        $this->assertStringContainsString('viewBox="0 0 496 512" aria-hidden="true" role="img" class="svg-inline--fa svg-inline--fa-w-16" id="w2"', IconWidget::widget(['name' => 'github', 'options' => ['style' => 'brands']]));
        $this->assertStringContainsString('viewBox="0 0 512 512" aria-hidden="true" role="img" class="svg-inline--fa svg-inline--fa-w-16" id="w3"', IconWidget::widget(['name' => 'nonexistent']));
    }
